...
abstract class PlutoGridSettings {
  ...
  static const EdgeInsets columnTitlePadding = EdgeInsets.symmetric(horizontal: 18, vertical: 6);

  static const EdgeInsets columnFilterPadding = EdgeInsets.symmetric(horizontal: 12, vertical: 4);
